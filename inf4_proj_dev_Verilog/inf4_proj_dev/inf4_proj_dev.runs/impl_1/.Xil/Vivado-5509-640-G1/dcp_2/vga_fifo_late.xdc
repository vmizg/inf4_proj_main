set_property SRC_FILE_INFO {cfile:/home/vytas/INF4/Verilog/init_xillybus/vivado-essentials/vga_fifo/vga_fifo/vga_fifo_clocks.xdc rfile:../../../init_xillybus/vivado-essentials/vga_fifo/vga_fifo/vga_fifo_clocks.xdc id:1 order:LATE scoped_inst:U0 rxprname:$PPRDIR/../init_xillybus/vivado-essentials/vga_fifo/vga_fifo/vga_fifo_clocks.xdc} [current_design]
...
set_max_delay -datapath_only -from [get_cells {inst_fifo_gen/gconvfifo.rf/grf.rf/gntv_or_sync_fifo.gcx.clkx/rd_pntr_gc_reg[*]}] -to [get_cells {inst_fifo_gen/gconvfifo.rf/grf.rf/gntv_or_sync_fifo.gcx.clkx/gsync_stage[*].wr_stg_inst/Q_reg_reg[*]}] 10.000
...
set_max_delay -datapath_only -from [get_cells {inst_fifo_gen/gconvfifo.rf/grf.rf/gntv_or_sync_fifo.gcx.clkx/wr_pntr_gc_reg[*]}] -to [get_cells {inst_fifo_gen/gconvfifo.rf/grf.rf/gntv_or_sync_fifo.gcx.clkx/gsync_stage[*].rd_stg_inst/Q_reg_reg[*]}] 10.000
